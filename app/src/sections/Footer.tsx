          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center">
                <span className="text-white font-bold text-xl" aria-hidden="true">CP</span>
              </div>
              <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-blue-200 text-center md:text-left">
              &copy; {new Date().getFullYear()} Studio Costanzo-Pagano. Tutti i
              diritti riservati.
            </p>
            <div className="flex items-center gap-4 text-sm text-blue-200">
              {/* TODO: Aggiungere link a privacy policy e cookie policy */}
              <button
